...
namespace KalenderApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public IActionResult AddNewEvent(string name, List<int> categoryid, string startTime, string endTime, string location, string repetition)
        {
            try
            {
        ...
        [HttpPost]
        public IActionResult EditEvent(int id, List<int> categoryid, string name, string startTime, string endTime, string location, string repetition)
        {
            try
            {
                DateTime start = DateTime.Parse(startTime);
